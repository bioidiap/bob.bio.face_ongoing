...
model_dir = "/idiap/temp/tpereira/casia_webface/new_tf_format/inception_resnet_v2/crossentropy_rmsprop"
...
#learning_rate = tf.train.exponential_decay(learning_rate, global_step, 60000, 0.5, staircase=True)
